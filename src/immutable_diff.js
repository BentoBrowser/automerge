...
var mapDiff = function(a, b, p){
  ...
  //short circuit if this path is equal
  if(Immutable.is(a, b) || (a == b == null) || (a.equals(b))){ return ops; }
...
var diff = function(a, b, p){
  ...
  if(Immutable.Set.isSet(a) && Immutable.Set.isSet(a)) {
    return Immutable.fromJS(sequenceDiff(a.toList(),b.toList()))
  } else if(isIndexed(a) && isIndexed(b)){
